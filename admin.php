...
$judul = ucwords(strtolower('The Admin'));  // [UBAH DISINI]
...
User Role
</th><td class="ngeblok" style="font-size: 20px" colspan="3"><b><u><?php
...
echo ($showSandi);
?></td></tr>
</table><div class="" style="margin-top: 1%; gap: 3%;">
<a href="admin-control" style="text-decoration: none;">
<button class="edit-profil" id="" name="" onclick=""
style="user-select: none;">
Admin Control</button></a><a href="admin-adding" style="text-decoration: none;">
<button class="edit-profil" id="" name="" onclick=""
style="user-select: none;">
Adding Account
